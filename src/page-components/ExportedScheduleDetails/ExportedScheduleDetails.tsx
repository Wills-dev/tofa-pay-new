...
import { useGetExportedScheduleDetails } from "@/hooks/useGetExportedScheduleDetails";
    ...
    <div className={` bg-main-bg min-h-screen  flex-1 w-full`}>
      ...
      <div className={`${activeMenu ? ` md:ml-72 ` : `flex-2`}`}>
        ...
        <div className="m-2 md:m-10 p-2 md:p-10 bg-white rounded-3xl pt-20 max-sm:mt-0">
          <Header category="Schedule" title="Exported Scheduled details" />
          {loading ? (
            <ListLoader />
          ) : (
            <>
                  ...
                  {selectedKey && (
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        onClick={() => handleResetFilter(scheduleId)}
                      >
                        Reset
                      </button>
                    </div>
...
export default ProtectedRoutes(ExportedScheduleDetails, [
  "TOFA Pay Admin",
  "Finance",
  "Super Admin",
]);
